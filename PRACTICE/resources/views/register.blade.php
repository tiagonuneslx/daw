...
<section class="contact-page-area section-gap">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <form action="{{action('Bakery@registerAction')}}" method="post" class="form-area " id="myForm"
                    ...
                    <div class="row">
                        <div class="col-lg-6 form-group">
                            ...
                            <input name="password_confirmation" placeholder="Repeat password"
                                   onfocus="this.placeholder = ''"
                                   onblur="this.placeholder = 'Repeat password'" class="common-input mb-20 form-control"
                                   required="" type="password">
                        </div>
                        <div class="col-lg-12">
