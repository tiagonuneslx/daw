        ...
        <div class="row align-items-center justify-content-between d-flex">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li><a href="{{action('Bakery@register')}}">Register</a></li>
            ...
            <div class="menu-cat mx-auto">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    @foreach($categories as $category)
                        <li class="nav-item">
                            <a class="nav-link @if($category->id === $cat_id) active @endif"
                               id="{{$category->name}}-tab" data-toggle="pill"
                               href="{{action("Bakery@menu", ['id' => $category->id])}}" role="tab"
                               aria-controls="{{$category->name}}"
                               aria-selected="{{$category->id === $cat_id}}">{{$category->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
