...
<head>
    ...
    <title>TechTo - Loja Online Eletrónica</title>
    ...
    <div id="top-header">
        <div class="container">
            ...
            <ul class="header-links pull-right">
                @if($user_id !== -1)
                    <li><a href="{{action("Store@orders")}}"><i class="fa fa-user-o"></i> Histórico de encomendas</a></li>
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                @foreach($categories as $category)
                    <li @if($category->id == $active_category)class="active"@endif><a
                                href="{{action("Store@index", ['id' => $category->id])}}">{{$category->name}}</a>
                    </li>
                @endforeach
            </ul>
            <!-- /NAV -->
                                ...
                                @foreach($products as $product)
                                    <div class="product">
                                        ...
                                        <div class="add-to-cart">
                                            <a href="{{action("Store@cartItemInsert", ["id" => $product->id])}}">
