...
<div class="section" style="margin-bottom: 40px">
    <div class="container">
        <h2 class="text-center" style="margin: 20px 0">Criar Conta</h2>
        <form action="{{action("Store@registerAction")}}" method="post" class="p-2 mb-4"
            ...
            <div class="form-group row d-flex justify-content-center">
                <label class="col-sm-2 col-form-label" for="inputName">Nome</label>
                <div class="col-sm-7">
                    <input class="form-control" id="inputName" placeholder="Nome" type="text" name="name"
                           value="{{old('name')}}">
                </div>
            </div>
            <div class="form-group row d-flex justify-content-center">
            ...
            <div class="form-group row d-flex justify-content-center">
                <label class="col-sm-2 col-form-label" for="inputPassword2">Confirmar Password</label>
                <div class="col-sm-7">
                    <input class="form-control" id="inputPassword2" placeholder="Confirmar Password" type="password"
                           name="password_confirmation">
                </div>
            </div>
            <div style="margin-left: 160px">
                <div class="col-sm-1" style="margin-right: 18px; text-align: center">
                    <button class="btn btn-primary px-4" type="submit">Registar</button>
                </div>
                <div class="col-sm-1">
                    <button class="btn btn-secondary px-4" type="reset">Limpar</button>
                </div>
            </div>
        </form>
    </div>
